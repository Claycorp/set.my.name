...
import static net.doubledoordev.saymyname.TranslationHelper.createSuggestedTranslation;
...
//        });
        ...
        SetMyName.LOGGER.error("Each entry is automatically prepared for inserting into a language json file with a suggested en_us translation, just copy paste!");

        missingTranslations.forEach(s -> SetMyName.LOGGER.error("\"" + s + "\": \"" + createSuggestedTranslation(s) + "\","));
    }
